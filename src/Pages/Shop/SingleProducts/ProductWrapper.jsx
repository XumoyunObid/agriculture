    ...
    <div className="container px-[50px] flex gap-[85px] pt-[110px]">
      ...
      <div className="flex flex-col items-start justify-center w-1/2">
        ...
        <p className="text-base text-cityRain py-[35px]">
          ...
          <br /> ceased to been the industry's standard dummy text ever since
          the 1500s, <br /> when an unknown printer took a galley.
        </p>
        <div className="flex items-center gap-6">
          <p className="text-primary text-xl font-bold">Quantity: </p>
          <div className="flex items-center gap-5">
            <Button variant="third" onClick={handleIncre}>
              {number}
            </Button>
